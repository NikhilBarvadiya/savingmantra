...
class FinancialServicesPage extends StatefulWidget {
  ...
  @override
  State<FinancialServicesPage> createState() => _FinancialServicesPageState();
}

class _FinancialServicesPageState extends State<FinancialServicesPage> {
  String activeTab = "Child Plan";

  final List<String> financialTabs = const ["Child Plan", "Investments", "Insurance", "Loans", "Retirement Plan", "Mutual Funds"];

  final Map<String, List<_FinancialProduct>> sampleData = {
    "Child Plan": [
      _FinancialProduct(date: "15-Mar-2025", name: "HDFC YoungStar Super", status: "Active", amount: "₹ 1,20,000", provider: "HDFC Life"),
      _FinancialProduct(date: "01-Apr-2025", name: "LIC Jeevan Tarun", status: "Active", amount: "₹ 90,000", provider: "LIC"),
    ],
    "Investments": [
      _FinancialProduct(date: "10-Oct-2025", name: "Fixed Deposit", status: "Active", amount: "₹ 5,00,000", provider: "HDFC Bank"),
      _FinancialProduct(date: "15-Sep-2025", name: "Corporate Bonds", status: "Matured", amount: "₹ 3,00,000", provider: "AAA PSU"),
    ],
    "Insurance": [_FinancialProduct(date: "20-Nov-2025", name: "Term Life Insurance", status: "Active", amount: "₹ 50,00,000", provider: "ICICI Pru")],
  };
  ...
  Widget _buildKPISection() {
    return Container(
      ...
      child: Row(
        children: [
          _buildKPIItem('Portfolio Value', '₹ 28.5L', Icons.trending_up_outlined, const Color(0xFF10B981), '+4.2% this quarter'),
          const SizedBox(width: 24),
          _buildKPIItem('Active Policies', '17', Icons.description_outlined, const Color(0xFF3B82F6), '3 renewals due'),
          const SizedBox(width: 24),
          _buildKPIItem('Upcoming Maturities', '4', Icons.calendar_today_outlined, const Color(0xFFF59E0B), '₹ 2.4L expected'),
          const SizedBox(width: 24),
          _buildKPIItem('Goals Tracking', '3', Icons.flag_outlined, const Color(0xFF8B5CF6), '58% completed'),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Explore and apply for different financial products', style: TextStyle(fontSize: 14, color: Color(0xFF6B7280))),
  ...
  Widget _buildProductsGrid() {
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 12, mainAxisSpacing: 12, childAspectRatio: 4),
      ...
      child: Container(
        ...
        child: DataTable(
          ...
          columns: const [
            ...
            DataColumn(
              label: Text('Start Date', style: TextStyle(fontWeight: FontWeight.w700)),
            ),
            DataColumn(
              label: Text('Product Name', style: TextStyle(fontWeight: FontWeight.w700)),
            ),
            DataColumn(
              label: Text('Provider', style: TextStyle(fontWeight: FontWeight.w700)),
            ),
            DataColumn(
              label: Text('Amount', style: TextStyle(fontWeight: FontWeight.w700)),
            ),
            DataColumn(
...
class _FinancialProduct {
  ...
  const _FinancialProduct({required this.date, required this.name, required this.status, required this.amount, required this.provider});
}
