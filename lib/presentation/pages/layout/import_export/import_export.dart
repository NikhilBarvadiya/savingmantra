...
class ImportExportPage extends StatefulWidget {
  ...
  @override
  State<ImportExportPage> createState() =>
      _ImportExportPageState();
}
...
class _ImportExportPageState extends State<ImportExportPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: Text(
                "© 2025 Saving Mantra — Data Management Module",
  ...
  Widget _buildTemplatesSection() {
    final templates = [
      _Template(
        'Financial Data',
        'Client portfolio, investments, policies',
        'Excel',
      ),
      _Template(
        'CRM Contacts',
      ...
      _Template(
        'Legal Documents',
        'Case data and document references',
        'Excel',
      ),
    ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          const Text(
            'Use these templates to ensure your data is properly formatted for import',
