...
class TodoRepository implements ITodoRepository {
  ...
  Future<List<dynamic>> getTodoList({required String planDate, required String planStatus}) async {
    try {
      ...
      final response = await _apiService.post(ApiConstants.plannerDayList, {'Auth': _apiService.token, 'PlanDate': planDate, 'PlanStatus': planStatus});
  ...
  Future<Map<String, dynamic>> addTodo({required String planDate, required String taskDes}) async {
    try {
      // final auth = "jvZVSzvERAlIB9tiyK5c/1Bc3z3PzMWsnuh7O16yzQdA/x/HXBFwPqhd4fc6FSaK/y8KKArnmwFX2oWNa/IukeIqY/Uh3HS+ZhkHltuvgIU=";
      final response = await _apiService.post(ApiConstants.plannerAddPlan, {'Auth': _apiService.token, 'PlanDate': planDate, 'TaskDes': taskDes});
      return response;
    } catch (e) {
  ...
  Future<Map<String, dynamic>> updateTodoStatus({required String busPlannerid, required String planStatus}) async {
    try {
      // final auth = "jvZVSzvERAlIB9tiyK5c/1Bc3z3PzMWsnuh7O16yzQdA/x/HXBFwPqhd4fc6FSaK/y8KKArnmwFX2oWNa/IukeIqY/Uh3HS+ZhkHltuvgIU=";
      final response = await _apiService.post(ApiConstants.plannerUpdateStatus, {'Auth': _apiService.token, 'BusPlannerId': busPlannerid, 'PlanStatus': planStatus});
      return response;
    } catch (e) {
